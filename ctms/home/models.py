...
class Team(models.Model):
    ...
    noofdraws = models.IntegerField(db_column='NoOfDraws', blank=True, null=True)  # Field name made lowercase.
    noofwins = models.IntegerField(db_column='NoOfWins', blank=True, null=True)  # Field name made lowercase.
    nooflosses = models.IntegerField(db_column='NoOfLosses', blank=True, null=True)  # Field name made lowercase.
...
class Matches(models.Model):
    ...
    teama_id = models.ForeignKey(Team, db_column='teamA_ID', related_name="teamA",on_delete=models.CASCADE)  # Field name made lowercase.
    teamb_id = models.ForeignKey(Team, db_column='teamb_ID', related_name="teamB",on_delete=models.CASCADE)  # Field name made lowercase.
...
class Player(models.Model):
    ...
    teamid = models.ForeignKey(Team, db_column='TeamID', on_delete=models.CASCADE)  # Field name made lowercase.
...
class Captain(models.Model):
    ...
    playerid = models.ForeignKey(Player, db_column='PlayerID', on_delete=models.CASCADE)
    noofmatches = models.IntegerField(db_column='NoOfMatches', blank=True, null=True)  # Field name made lowercase.
    noofwins = models.IntegerField(db_column='NoOfWins', blank=True, null=True)  # Field name made lowercase.
...
class Plays(models.Model):
    ...
    matchid = models.ForeignKey(Matches, db_column='MatchID', on_delete=models.CASCADE)  # Field name made lowercase.
...
class Umpiredby(models.Model):
    ...
    umpireid = models.ForeignKey(Umpire, db_column='UmpireID', on_delete=models.CASCADE)  # Field name made lowercase.
